...
<head>
  ...
  <style>
    ...
    .reports-card::before {
      ...
      width: 100%;
      height: 4px;
      background: linear-gradient(to right, var(--soil-dark), var(--earth-green));
    }
    
    .table thead {
      background: linear-gradient(to right, var(--soil-dark), var(--soil-medium));
      color: white;
    }
    ...
    .dot-good { background-color: var(--leaf-green); }
    .dot-warning { background-color: #ffc107; }
    .dot-poor { background-color: #dc3545; }
  ...
  <div class="container-custom">
    ...
    <div class="header-card">
      <div class="d-flex justify-content-between align-items-center flex-wrap">
        <h3 class="mb-0"><span class="soil-icon"></span>Soil Analysis Reports</h3>
        <div class="d-flex align-items-center flex-wrap gap-2">
          <a href="index.jsp" class="btn btn-new-test">
            <i class="fas fa-flask me-1"></i>New Test
          </a>
      ...
      <% if (soilList != null && !soilList.isEmpty()) { %>
        <div class="d-flex justify-content-center flex-wrap mb-4">
          <div class="summary-badge">
            ...
            <strong><%= soilList.size() %></strong> Total Tests
          </div>
          <div class="summary-badge">
              ...
              <tr>
                ...
                <td>
                  <div class="param-indicator">
                    <span class="param-dot <%= 
                      s.getPh() >= 6.0 && s.getPh() <= 7.5 ? "dot-good" : 
                      (s.getPh() >= 5.5 && s.getPh() <= 8.0 ? "dot-warning" : "dot-poor") 
                    %>"></span>
                    <span class="<%= 
                      s.getPh() >= 6.0 && s.getPh() <= 7.5 ? "status-good" : 
                ...
                <td>
                  <div class="param-indicator">
                    <span class="param-dot <%= 
                      s.getMoisture() >= 40 && s.getMoisture() <= 60 ? "dot-good" : 
                      (s.getMoisture() >= 30 && s.getMoisture() <= 70 ? "dot-warning" : "dot-poor") 
                    %>"></span>
                    <span class="<%= 
                      s.getMoisture() >= 40 && s.getMoisture() <= 60 ? "status-good" : 
                ...
                <td>
                  <div class="param-indicator">
                    <span class="param-dot <%= 
                      s.getOrganic() >= 3.0 ? "dot-good" : 
                      (s.getOrganic() >= 1.5 ? "dot-warning" : "dot-poor") 
                    %>"></span>
                    <span class="<%= 
                      s.getOrganic() >= 3.0 ? "status-good" : 
                      (s.getOrganic() >= 1.5 ? "status-warning" : "status-poor") 
                    %>">
                      <%= s.getOrganic() %>%
                    </span>
                  </div>
              ...
              <tr>
                <td colspan="8" class="text-center py-4">
                  <div class="empty-state">
                    ...
                    <a href="index.jsp" class="btn btn-new-test mt-3">
                      <i class="fas fa-flask me-1"></i>Perform First Test
                    </a>
                  </div>
                </td>
              </tr>
    ...
    <% if (soilList != null && !soilList.isEmpty()) { %>
      <div class="stats-card">
        ...
        <div class="stats-grid">
          <div class="stat-item">
            <i class="fas fa-flask stat-icon" style="color: var(--soil-medium);"></i>
            <span class="stat-value"><%= soilList.size() %></span>
            <span class="stat-label">Total Tests</span>
          </div>
          
          <div class="stat-item">
            <i class="fas fa-map-marker-alt stat-icon" style="color: var(--water-blue);"></i>
            <%
            ...
            <span class="stat-label">Test Locations</span>
          </div>
          
          <div class="stat-item">
            <i class="fas fa-seedling stat-icon" style="color: var(--leaf-green);"></i>
            <%
            ...
            %>
            <span class="stat-value"><%= uniqueCrops.size() %></span>
            <span class="stat-label">Crop Types</span>
          </div>
          
          <div class="stat-item">
            <i class="fas fa-calendar-alt stat-icon" style="color: var(--earth-green);"></i>
            <%
        ...
        <div class="mt-4 pt-3 border-top">
          ...
          <div class="d-flex justify-content-center flex-wrap gap-3">
            <div class="param-indicator">
              <span class="param-dot dot-good"></span>
              <small>Optimal</small>
            </div>
            <div class="param-indicator">
              <span class="param-dot dot-warning"></span>
              <small>Acceptable</small>
            </div>
            <div class="param-indicator">
              <span class="param-dot dot-poor"></span>
