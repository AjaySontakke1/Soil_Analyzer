...
<body>
	...
	<div class="container">
			...
			<table>
				...
				<tbody>
					...
					<tr>
						...
						<td>••••••••</td>
						<td><i class="fas fa-phone"
							style="color: #95a5a6; margin-right: 8px;"></i> <%=user.getContact()%>
						</td>
						<td><i class="fas fa-envelope"
							style="color: #95a5a6; margin-right: 8px;"></i> <%=user.getEmail()%>
						</td>
						<td>
		...
		<div class="footer">
			<a href="adminDashboard.jsp" class="back-link"> <i
