    ...
    <div class="login-container">
        ...
        <div class="login-card">
            <div class="card-header">
                <h2><i class="fas fa-seedling me-2"></i>Soil Analyzer</h2>
        ...
        <div class="footer-text">
            <p>&copy; 2023 Soil Analyzer | <a href="#" class="text-light text-decoration-none">Privacy Policy</a> | <a href="#" class="text-light text-decoration-none">Terms of Service</a></p>
        </div>
    </div>
