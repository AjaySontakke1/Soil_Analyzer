...
@media (prefers-reduced-motion: reduce) {
    .btn-logout:hover, .btn-search:hover, .btn-filter:hover, .btn-delete:hover, .btn-users:hover {
        transform: none;
    }
...
@media (hover: none) and (pointer: coarse) {
    ...
    .btn-logout:active, .btn-search:active, .btn-filter:active, .btn-delete:active, .btn-users:active {
  ...
  <div class="container-custom">
    ...
    <div class="header-card">
      <div class="d-flex justify-content-between align-items-center flex-wrap">
        <h3 class="mb-0"><span class="soil-icon"></span>Admin Dashboard - Soil Analysis</h3>
        <div class="d-flex gap-2">
          <a href="ViewUserServlet" class="btn btn-users">
    ...
    <div class="search-filter-card">
      <div class="d-flex justify-content-between flex-wrap gap-3">
        <form class="d-flex flex-grow-1" method="get" action="AdminDashboardServlet">
          <div class="input-group">
            <span class="input-group-text bg-light"><i class="fas fa-search"></i></span>
            <input type="text" name="searchUser" class="form-control" placeholder="Search by username">
        ...
        <form class="d-flex flex-grow-1" method="get" action="AdminDashboardServlet">
          <div class="input-group">
            ...
            <input type="text" name="filterLocation" class="form-control" placeholder="Filter by location">
      ...
      <div class="table-responsive">
        <table class="table table-bordered table-hover">
          <thead class="table-dark">
            <tr>
              <th>ID</th><th>User</th><th>Location</th><th>pH</th><th>Moisture</th>
              <th>Organic</th><th>Crops</th><th>Email</th><th>Date</th><th>Action</th>
            </tr>
          </thead>
          <tbody>
            <%
            ...
            %>
              <tr>
                ...
                <td><%= s.getTestDate() %></td>
                <td><a href="DeleteSoilServlet?id=<%= s.getId() %>" class="btn btn-delete btn-sm"><i class="fas fa-trash me-1"></i>Delete</a></td>
              </tr>
            <%   }
              } else { %>
          ...
          <div class="chart-container">
            ...
            <div class="chart-legend">
              <div class="legend-item">
                <div class="legend-color" style="background-color: var(--chart-soil);"></div>
                <span>pH Level</span>
              </div>
              <div class="legend-item">
                <div class="legend-color" style="background-color: var(--chart-moisture);"></div>
                <span>Moisture %</span>
              </div>
              <div class="legend-item">
                <div class="legend-color" style="background-color: var(--chart-organic);"></div>
                <span>Organic %</span>
              </div>
            </div>
          </div>
