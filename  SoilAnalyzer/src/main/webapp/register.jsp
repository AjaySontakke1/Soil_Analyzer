	...
	<div class="registration-container">
		<div class="registration-card">
			<div class="registration-header">
				<h2>
					<span class="soil-icon"></span>Create Your Account
				</h2>
				<p>Join our soil analysis community and grow with us</p>
			</div>

			<div class="alert-message text-danger">${msg}</div>

			<form action="RegisterServlet" method="post">
				<div class="form-group">
					<label class="form-label"> <i class="fas fa-user"></i> Full
						Name
				...
				<div class="form-group">
					<label class="form-label"> <i class="fas fa-envelope"></i>
						Email Address <span class="optional-badge">Optional</span>
					</label> <input type="email" name="email" class="form-control"
						placeholder="Optional - soil analysis reports will be emailed">
				</div>
			...
			<div class="login-link">
				Already have an account? <a href="login.jsp">Sign in to your
					soil dashboard</a>
			</div>
		</div>
	</div>
	...
	<script>
		document
				.addEventListener(
						...
						function() {
							// Create plants
							const plantContainer = document
									.getElementById('plantContainer');
							const plantCount = 12;
							...
							for (let i = 0; i < plantCount; i++) {
								...
								plant.style.setProperty('--plant-height',
										`${height}px`);

								// Add leaves
								const leafCount = 2 + Math
										.floor(Math.random() * 3);
