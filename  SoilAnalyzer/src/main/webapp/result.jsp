	...
	<div class="container-custom">
		...
		<div class="header-card">
			<div
				...
				<h3 class="mb-0">
					<span class="soil-icon"></span>Soil Analysis Report
				</h3>
				<a href="index.jsp" class="btn btn-back"> <i
					class="fas fa-arrow-left me-1"></i>Back to Analysis
				</a>
			</div>
		</div>
